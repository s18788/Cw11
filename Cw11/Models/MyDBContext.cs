    ...
    public class MyDbContext : DbContext
    {
        ...
        private void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Doctor>().HasData(
             ...
             new Doctor { IdDoctor = 2, FirstName = "Marcin", LastName = "Malędowski", Email = "moleda@wp.pl" },
             new Doctor { IdDoctor = 3, FirstName = "Krzysztof", LastName = "Kowalewicz", Email = "kowalewicz@wp.pl" },
             new Doctor { IdDoctor = 4, FirstName = "Anna", LastName = "Kostrzewska", Email = "akostrzew@onet.pl" }
             );
            ...
            modelBuilder.Entity<Medicament>().HasData(
             new Medicament { IdMedicament = 1, Name = "Xanax", Description = "Lorem ipsum...", Type = "Depression" },
             new Medicament { IdMedicament = 2, Name = "Abilify", Description = "Lorem.", Type = "Tabletki" },
             new Medicament { IdMedicament = 3, Name = "Abra", Description = "Lorem...", Type = "Żel" },
             new Medicament { IdMedicament = 4, Name = "Acai", Description = "Test", Type = "Kapsułki" },
             new Medicament { IdMedicament = 5, Name = "ACC", Description = "Lorem ipsum...", Type = "Tabletki" },
             new Medicament { IdMedicament = 6, Name = "Acerin", Description = "Lorem...", Type = "Płyn" }
             );
            ...
            modelBuilder.Entity<PrescriptionMedicament>().HasData(
             new PrescriptionMedicament { IdMedicament = 1, IdPrescription = 1, Dose = 4, Details = "Take every morning" },
             new PrescriptionMedicament { IdMedicament = 1, IdPrescription = 2, Dose = 1, Details = "Once a week" },
             new PrescriptionMedicament { IdMedicament = 1, IdPrescription = 3, Dose = 3, Details = "Once every two weeks" },
             new PrescriptionMedicament { IdMedicament = 2, IdPrescription = 1, Dose = 10, Details = "Every evening" },
             new PrescriptionMedicament { IdMedicament = 3, IdPrescription = 2, Dose = 7, Details = "Once every day after main meal" }
             );
